...
class Contact extends Component {
    ...
    //         errors.firstname="name should not be <3 characters"
    //     else if(this.state.touched.firstname && firstname.length > 10)
    //         errors.firstname="name should not be > 10 characters"
        
    //     if(this.state.touched.lastname && lastname.length < 3)
    //         errors.lastname="name should not be <3 characters"
    //     else if(this.state.touched.lastname && lastname.length > 10)
    //         errors.lastname="name should not be > 10 characters"

    //     const reg=/^\d+$/;
    //     if(this.state.touched.telnum && !reg.test(telnum))
    //         errors.telnum="It should contain digits only"
